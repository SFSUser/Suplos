...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 31, 2020 at 01:37 AM
...
--
-- Table structure for table `bienes_guardados`
--
...
--
-- Indexes for table `bienes_guardados`
--
...
--
-- AUTO_INCREMENT for table `bienes_guardados`
--
ALTER TABLE `bienes_guardados`
...
--
-- Constraints for table `bienes_guardados`
--
ALTER TABLE `bienes_guardados`
  ADD CONSTRAINT `bienes_guardados_ibfk_1` FOREIGN KEY (`Bien`) REFERENCES `bienes` (`Id`);
COMMIT;
